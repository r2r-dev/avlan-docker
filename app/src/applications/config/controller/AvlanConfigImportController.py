...
from src.applications.config.view.AvlanConfigImportView import AvlanConfigImportView
...
class AvlanConfigImportController(AvlanAuthorizedController):
    def get(self):
