...
from src.applications.config.view.AvlanConfigRunView import AvlanConfigRunView
...
class AvlanConfigRunController(AvlanAuthorizedController):
    def get(self, config_id):
        config_api = AvlanConfigApi(
            self.dao,
            self.redis,
        )
